...
const ResumePage = () => (
  <Layout>
    ...
    <h4>2019/03/01 - Present</h4>

    <h5>Team: Developer experience </h5>
    <p>
      I was responsible for creating a seamless development experience for a team of 90+ engineers with a primary focus
      on
      the backend. Our current challenges include transitioning the team of developers from SVN to git, creating
      continuous delivery, integration and deployment pipelines in Kubernetes while also streamlining all aspects of the
      development process.
    </p>
    ...
    <p>
      While on the scheduling team I identified the need to develop in more than just jQuery on the frontend. I
      developed
      the first feature in React and helped grow the learnings that I took from integrating React into the product into
      a
    ...
    <p>
      I volunteered for a local music festival for a few years. This helped to scratch my itch to learn about deploying
      to
